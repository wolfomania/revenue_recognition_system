        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KRS = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfferType = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Discounts",
                columns: new[] { "DiscountId", "EndDate", "Name", "OfferType", "StartDate", "Value" },
                values: new object[] { 1, null, "Previous Customer", " Discount for previous customers 5%", null, 5.0 });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmployeeId", "Login", "Password", "RefreshToken", "RefreshTokenExp", "Role", "Salt" },
                values: new object[] { 1, "admin", "QOk4aSwBr+H7CdnZ6i3tGs/YTbD6dN0Q0Uz9KJ4Zowk=", "VV7RpOmSNNyuxnbi8E35PIrM7F/ppntuZwQEQd+qqj8=", new DateTime(2024, 6, 29, 22, 44, 13, 222, DateTimeKind.Local).AddTicks(6941), "Admin", "i179LXhlI/O+Qjpa/WacSg==" });
